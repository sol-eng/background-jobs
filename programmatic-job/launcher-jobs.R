...
# Start 5 concurrent Launcher jobs
n <- 3
jobs <- replicate(n, rstudioapi::launcherSubmitR(script = here::here("programmatic-job", "estimate-pi.R"), 
                                                 cluster = "Kubernetes", 
                                                 container = rstudioapi::launcherContainer("rstudio/r-session-complete:centos7-1.2.1511-1")))
